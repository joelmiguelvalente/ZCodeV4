                                ...
                                <div class="Story" id="pub_{$p.pub_id}">
                                    ...
                                    <div class="Story_Content">
                                        ...
                                        <div class="Story_Foot">
                                            ...
                                            <ul id="comment_pub--{$p.pub_id}" class="Story_Comments" {if $p.p_comments == 0}style="display:none"{/if}>
                                                ...
                                                <li class="ufiItem">
                                                    <div class="newComment">
                                                        ...
                                                        <div class="formulario" style="display:none">
                                                            ...
                                                            <textarea class="comentar" title="Escribe un comentario..." id="comment--{$p.pub_id}" name="add_comment"></textarea>
