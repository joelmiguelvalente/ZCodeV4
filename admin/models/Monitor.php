    ...
    private function makeOracion(array $data = [])
    {
        ...
        switch ($no_type) {
            ...
            case 9:
                ...
                $oracion['link'] = $this->linkMonitorOfPost($data, $id_comment);
                $oracion['ltext'] = ($this->show_type == 1) ? $ln_text : $data['post_title'];
                $oracion['ltit'] = ($this->show_type == 1) ? $data['post_title'] : '';
                break;
            case 8:
            ...
            case 12:
                $oracion['text'] = $this->monitor[$no_type]['text'] . $txt_extra;
                $oracion['link'] = $tsCore->createLink('perfil', ['nick' => $tsUser->nick, 'extra' => '/' . $data['obj_uno']]);
            ...
            case 13:
                ...
                //
                $oracion['link'] = $tsCore->createLink('perfil', ['nick' => $data['p_user_name'], 'extra' => '/' . $data['pub_id']]);
                $oracion['ltext'] = ($this->show_type == 1) ? $ln_text : $tsUser->nick;
                $oracion['ltit'] = ($this->show_type == 1) ? $tsUser->nick : '';
                break;
            case 14:
            ...
            case 16:
                ...
                $post_link = $this->linkMonitorOfPost($data);
