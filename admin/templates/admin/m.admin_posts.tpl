								...
								<div class="empty hero">No hay posts.</div>
								{else}
									...
									<tbody>
										...
										<tr id="post_{$p.post_id}">
											...
											<td class="admin_actions">
												<a href="{$tsConfig.url}/posts/editar/{$p.post_id}"><img src="{$tsConfig.public}/images/icons/editar.png" title="Editar Post" /></a>
												{if $p.post_status == 2}
													<a href="#" onclick="admin.posts.borrar({$p.post_id}); return false"><img src="{$tsConfig.public}/images/icons/close.png" title="Borrar Post permanentemente" /></a>
												{else}
													<a href="#" onclick="mod.posts.borrar({$p.post_id}, 'posts', null); return false;"><img src="{$tsConfig.public}/images/icons/close.png" title="Borrar Post" /></a>
												{/if}
											</td>
										</tr>
										{/foreach}
