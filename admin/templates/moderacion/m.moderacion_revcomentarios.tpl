								...
								<div class="empty hero">No hay comentarios ocultos</div>
								{else}
									...
									<tbody>
										...
										<tr id="div_cmnt_{$c.cid}">
											...
											<td class="admin_actions">
												<a href="#" onclick="ocultar_com({$c.cid}, {$c.c_user});"><img src="{$tsConfig.public}/images/icons/reboot.png" title="Reactivar/Ocultar Comentario" /></a>											
												<a href="#" onclick="borrar_com({$c.cid}, {$c.c_user}, {$c.post_id});"><img src="{$tsConfig.public}/images/icons/close.png" title="Eliminar comentario" /></a>											
											</td>
										</tr>
										{/foreach}
									</tbody>
