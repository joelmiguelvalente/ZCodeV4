								...
								{if !$tsFopelera.datos}
								<div class="empty hero">No hay fotos eliminadas</div>
								{else}
									...
									<tbody>
										...
										<tr id="report_{$f.foto_id}">
											...
											<td class="admin_actions">
                                                    <a href="#" onclick="mod.reboot({$f.foto_id}, 'fotos', 'reboot', false); return false;"><img src="{$tsConfig.public}/images/icons/reboot.png" title="Reactivar Foto" /></a>
											</td>
										</tr>
										{/foreach}
									</tbody>
