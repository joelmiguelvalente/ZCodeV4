								...
								<div class="empty hero">No hay posts eliminados</div>
								{else}
								<table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center">
									...
									<tbody>
										...
										<tr id="report_{$p.post_id}">
                                            ...
                                            <a href="#" onclick="mod.reboot({$p.post_id}, 'posts', 'reboot', false); return false;"><img src="{$tsConfig.public}/images/icons/reboot.png" title="Reactivar Post" /></a>
											</td>
										</tr>
										{/foreach}
									</tbody>
